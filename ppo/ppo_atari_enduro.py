...
def parse_args():
    ...
    parser.add_argument("--gym-id", type=str, default='Enduro-v0',
                        help="the id of the gym environment")
    parser.add_argument('--model-file-name', type=str, default='enduro.pkl')
    ...
    parser.add_argument("--wandb-project-name", type=str, default="ppo-enduro",
